...
*--real-size*::
Use real file size (disk usage, i.e., *st_blocks* * 512) rather than apparent file size when applying *--minimum-size* and *--maximum-size* filters. This is useful for excluding sparse files that have large apparent size but use little or no actual disk space.
